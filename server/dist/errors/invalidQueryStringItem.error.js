...
class InvalidQueryStringItemError extends abstractCustom_error_1.default {
    constructor() {
        super(...arguments);
        this.status = httpStatusCodes_1.default.BAD_REQUEST;
        this.code = "INVALID_QUERY_ITEM";
    }
}
exports.default = InvalidQueryStringItemError;
//# sourceMappingURL=invalidQueryStringItem.error.js.map