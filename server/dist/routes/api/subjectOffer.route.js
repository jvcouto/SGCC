...
const subjectApprovalHistory_controller_1 = __importDefault(require("../../controllers/subjectApprovalHistory.controller"));
...
subjectOfferRoutes
    ...
    .post((0, expressCallback_1.default)((0, subjectApprovalHistory_controller_1.default)().create));
subjectOfferRoutes
